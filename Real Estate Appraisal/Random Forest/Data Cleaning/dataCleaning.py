...
veryTrimmedCols = ['LotFrontage','LotArea','TotalBsmtSF','1stFlrSF','2ndFlrSF','TotRmsAbvGrd','GarageArea','SalePrice']
...
#normalize
#df=(df-df.min())/(df.max()-df.min()) #mean 0, standard deviation of 1
#df=(df-df.mean())/df.std() #number between 0 and 1
...
df.to_excel("cleanedTrain.xlsx")
df_trimmed.to_excel("cleanedAndTrimmedTrain.xlsx")
#df_veryTrimmed.to_excel("data_cleaned/cleanedAndVeryTrimmedData.xlsx")